...
function Buttons ({ actualHomeState, dispatch, setNotFound, setPage, setValue }) {
    return (
        <>
            <button className={buttonsCss.btn_sort} onClick={() => resetDogs(dispatch, setNotFound, setPage, setValue)}>All dogs</button>
